  ...
  <div id="content">
    ...
    <section class="padding-top-60 padding-bottom-60">
      <div class="container">
        ...
        <div class="team">
          <div class="row">
            <div class="col-md-3"> <img class="img-responsive" src="{{ asset('assets/images/team-img-1.jpg') }}" alt="" >
              <h3>Tom Doe</h3>
              <span>Ceo/Founder SmartTech</span> </div>
            <div class="col-md-3"> <img class="img-responsive" src="{{ asset('assets/images/team-img-2.jpg') }}" alt="" >
              <h3>Tom Doe</h3>
              <span>Ceo/Founder SmartTech</span> </div>
            <div class="col-md-3"> <img class="img-responsive" src="{{ asset('assets/images/team-img-3.jpg') }}" alt="" >
              <h3>Tom Doe</h3>
              <span>Ceo/Founder SmartTech</span> </div>
            <div class="col-md-3"> <img class="img-responsive" src="{{ asset('assets/images/team-img-4.jpg') }}" alt="" >
              <h3>Tom Doe</h3>
              <span>Ceo/Founder SmartTech</span> </div>
          </div>
        </div>
