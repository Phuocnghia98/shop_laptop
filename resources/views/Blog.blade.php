      ...
      <div class="container">
        <div class="row">
          <div class="col-md-9">
            ...
            <div class="blog-post">
              <article class="row">
                <div class="col-xs-7"> <img class="img-responsive" src="{{ asset('assets/images/blog-img-1.jpg') }}" alt="" > </div>
            ...
            <div class="blog-post">
              <article class="row">
                <div class="col-xs-7"> <img class="img-responsive" src="{{ asset('assets/images/blog-img-2.jpg') }}" alt="" > </div>
            ...
            <div class="blog-post">
              <article class="row">
                <div class="col-xs-7"> <img class="img-responsive" src="{{ asset('assets/images/blog-img-3.jpg') }}" alt="" > </div>
                <div class="col-xs-5"> <span><i class="fa fa-bookmark-o"></i> 25 Dec, 2017</span> <span><i class="fa fa-comment-o"></i> 86 Comments</span> <a href="#." class="tittle">It’s why there’s nothing else like Mac. </a>
                  <p>Etiam porttitor ante non tellus pulvinar, non vehicula lorem fermentum. Nulla vitae efficitur mi.<br>
                    Maecenas sed pulvinar metus. Integer suscipit ac odio vulputate vehicula. Pellentesque consectetur viverra accumsan. Mauris varius convallis nisl [...] </p>
                  <a href="#.">Readmore</a></div>
            ...
            <div class="blog-post">
              <article class="row">
                <div class="col-xs-7"> <img class="img-responsive" src="{{ asset('assets/images/blog-img-4.jpg') }}" alt="" > </div>
                <div class="col-xs-5"> <span><i class="fa fa-bookmark-o"></i> 25 Dec, 2017</span> <span><i class="fa fa-comment-o"></i> 86 Comments</span> <a href="#." class="tittle">It’s why there’s nothing else like Mac. </a>
                  <p>Etiam porttitor ante non tellus pulvinar, non vehicula lorem fermentum. Nulla vitae efficitur mi.<br>
                    Maecenas sed pulvinar metus. Integer suscipit ac odio vulputate vehicula. Pellentesque consectetur viverra accumsan. Mauris varius convallis nisl [...] </p>
                  <a href="#.">Readmore</a></div>
            ...
            <div class="blog-post">
              <article class="row">
                <div class="col-xs-7"> <img class="img-responsive" src="{{ asset('assets/images/blog-img-5.jpg') }}" alt="" > </div>
                <div class="col-xs-5"> <span><i class="fa fa-bookmark-o"></i> 25 Dec, 2017</span> <span><i class="fa fa-comment-o"></i> 86 Comments</span> <a href="#." class="tittle">Get the power to take your business to the
                  next level. </a>
                  <p>Etiam porttitor ante non tellus pulvinar, non vehicula lorem fermentum. Nulla vitae efficitur mi.<br>
                    Maecenas sed pulvinar metus. Integer suscipit ac odio vulputate vehicula. Pellentesque consectetur viverra accumsan. Mauris varius convallis nisl [...] </p>
            ...
            <div class="blog-post">
              <article class="row">
                <div class="col-xs-7"> <img class="img-responsive" src="{{ asset('assets/images/blog-img-6.jpg') }}" alt="" > </div>
                <div class="col-xs-5"> <span><i class="fa fa-bookmark-o"></i> 25 Dec, 2017</span> <span><i class="fa fa-comment-o"></i> 86 Comments</span> <a href="#." class="tittle">It’s why there’s nothing else like Mac. </a>
                  <p>Etiam porttitor ante non tellus pulvinar, non vehicula lorem fermentum. Nulla vitae efficitur mi.<br>
                    Maecenas sed pulvinar metus. Integer suscipit ac odio vulputate vehicula. Pellentesque consectetur viverra accumsan. Mauris varius convallis nisl [...] </p>
                  <a href="#.">Readmore</a></div>
