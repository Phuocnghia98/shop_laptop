        ...
        <div class="row">
          ...
          <div class="col-md-9">
            ...
            <div class="item-col-4">
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="{{ asset('assets/images/item-img-1-1.jpg') }}" alt="" > <span class="sale-tag">-25%</span>
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="{{ asset('assets/images/item-img-1-3.jpg') }}" alt="" > <span class="new-tag">New</span>
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="{{ asset('assets/images/item-img-1-6.jpg') }}" alt="" > <span class="new-tag">New</span>
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="{{ asset('assets/images/item-img-1-9.jpg') }}" alt="" >
                  <!-- Content -->
                  <span class="tag">Appliances</span> <a href="#." class="tittle">Reloj Inteligente Smart Watch M26 </a>
                  <!-- Reviews -->
                  <p class="rev"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i> <i class="fa fa-star-o"></i> <span class="margin-left-10">5 Review(s)</span></p>
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="{{ asset('assets/images/item-img-1-10.jpg') }}" alt="" > <span class="new-tag">New</span>
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="{{ asset('assets/images/item-img-1-11.jpg') }}" alt="" >
                  <!-- Content -->
                  <span class="tag">Appliances</span> <a href="#." class="tittle">Funda Para Ebook 7" 128GB full HD</a>
                  <!-- Reviews -->
                  <p class="rev"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i> <i class="fa fa-star"></i> <span class="margin-left-10">5 Review(s)</span></p>
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="{{ asset('assets/images/item-img-1-12.jpg') }}" alt="" >
                  <!-- Content -->
                  <span class="tag">Appliances</span> <a href="#." class="tittle">Reloj Inteligente Smart Watch M26 </a>
                  <!-- Reviews -->
                  <p class="rev"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i> <i class="fa fa-star"></i> <span class="margin-left-10">5 Review(s)</span></p>
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="{{ asset('assets/images/item-img-1-13.jpg') }}" alt="" >
                  <!-- Content -->
                  <span class="tag">Appliances</span> <a href="#." class="tittle">Reloj Inteligente Smart Watch M26 </a>
                  <!-- Reviews -->
                  <p class="rev"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i> <i class="fa fa-star-o"></i> <span class="margin-left-10">5 Review(s)</span></p>
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="{{ asset('assets/images/item-img-1-14.jpg') }}" alt="" > <span class="new-tag">New</span>
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="{{ asset('assets/images/item-img-1-15.jpg') }}" alt="" >
                  <!-- Content -->
                  <span class="tag">Appliances</span> <a href="#." class="tittle">Funda Para Ebook 7" 128GB full HD</a>
                  <!-- Reviews -->
                  <p class="rev"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i> <i class="fa fa-star"></i> <span class="margin-left-10">5 Review(s)</span></p>
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="{{ asset('assets/images/item-img-1-16.jpg') }}" alt="" >
                  <!-- Content -->
                  <span class="tag">Appliances</span> <a href="#." class="tittle">Reloj Inteligente Smart Watch M26 </a>
                  <!-- Reviews -->
                  <p class="rev"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i> <i class="fa fa-star"></i> <span class="margin-left-10">5 Review(s)</span></p>
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="{{ asset('assets/images/item-img-1-17.jpg') }}" alt="" > <span class="new-tag">New</span>
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="{{ asset('assets/images/item-img-1-18.jpg') }}" alt="" >
                  <!-- Content -->
                  <span class="tag">Appliances</span> <a href="#." class="tittle">Funda Para Ebook 7" 128GB full HD</a>
                  <!-- Reviews -->
                  <p class="rev"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i> <i class="fa fa-star"></i> <span class="margin-left-10">5 Review(s)</span></p>
    ...
    <section class="padding-bottom-60">
      <div class="container">
        ...
        <div class="item-slide-5 with-nav">
          ...
          <!-- Product -->
          <div class="product">
            <article> <img class="img-responsive" src="{{ asset('assets/images/item-img-1-2.jpg') }}" alt="" > <span class="sale-tag">-25%</span>
          ...
          <!-- Product -->
          <div class="product">
            <article> <img class="img-responsive" src="{{ asset('assets/images/item-img-1-4.jpg') }}" alt="" > <span class="new-tag">New</span>
          ...
          <!-- Product -->
          <div class="product">
            <article> <img class="img-responsive" src="{{ asset('assets/images/item-img-1-6.jpg') }}" alt="" > <span class="sale-tag">-25%</span>
          ...
          <!-- Product -->
          <div class="product">
            <article> <img class="img-responsive" src="{{ asset('assets/images/item-img-1-8.jpg') }}" alt="" > <span class="new-tag">New</span>
