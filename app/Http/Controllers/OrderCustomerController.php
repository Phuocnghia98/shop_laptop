...
{
    public function ShowOrder(Request $resquest)
    {
        ...
        // }
        // $productdetail = Orderdetails::where('order_number', '=', $order_number)->get();
        // dd($productdetail);

        // return view('HistoryOrder', compact('customer', 'order', 'productdetail'));
        return view('HistoryOrder', compact('orders'));
    }

    public function payment(Request $resquest)
    {
        if (Auth::check()) {
            $id = Auth::user()->id;
        } else {
